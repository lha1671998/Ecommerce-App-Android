...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 22, 2023 lúc 04:54 AM
...
-- Cơ sở dữ liệu: `qloto`
--
CREATE DATABASE IF NOT EXISTS `qloto` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `qloto`;
...
(2, 'B7', 123, 12, 4343),
(4, 'FSC', 324, 34, 34324),
(8, 'HDSD', 1313, 99, 1000000000),
(8, 'RRW', 1123120, 23, 343434000),
(8, 'THL', 11111100, 66, 555556000);
...
INSERT INTO `hoadon` (`MaHD`, `MaKH`, `SDT`, `DiaChi`, `TongTien`, `NgayGio`) VALUES
(2, 3, '1312312', '31 tdt', 2132, ''),
(4, 3, '31231', '131231', 1323120, ''),
(6, 3, '113143', '32 tdt', 28000, '2023-03-21 16:24:32'),
(8, 3, '113114115', '13 thd', 1000000000, '13/6/2012'),
(10, 3, '113143', '32 tdt', 36600, '2023-03-21 19:43:09'),
(11, 3, '113143', '32 tdt', 175600, '2023-03-21 21:42:26'),
(12, 3, '113143', '32 tdt', 28000, '2023-03-21 21:46:37'),
(37, 3, '113143', '32 tdt', 45600, '2023-03-22 07:25:13'),
(38, 3, '113143', '32 tdt', 63900, '2023-03-22 07:25:50'),
(39, 3, '113143', '32 tdt', 36600, '2023-03-22 07:26:51'),
(40, 3, '113143', '32 tdt', 109800, '2023-03-22 07:27:45'),
(41, 3, '113143', '32 tdt', 304400, '2023-03-22 07:33:20'),
(42, 3, '113143', '32 tdt', 103980, '2023-03-22 07:34:42'),
(43, 3, '113143', '32 tdt', 63900, '2023-03-22 09:16:39'),
(44, 3, '113143', '32 tdt', 28000, '2023-03-22 09:19:19'),
(45, 3, '113143', '32 tdt', 124400, '2023-03-22 09:22:27'),
(46, 3, '113143', '32 tdt', 63900, '2023-03-22 09:28:26'),
(47, 3, '113143', '32 tdt', 25500, '2023-03-22 09:48:52'),
(48, 3, '113143', '32 tdt', 639000, '2023-03-22 09:58:19');
...
(39, 'Lê Ân', 'cloneden001@gmail.com', '', '', ''),
(40, 'Le An', 'an3@gmail.com', '123456', '31 thd', '123456789'),
(41, 'Ngiuryen Van A', 'vn@gmail.com', 'jdfugds', 'hgsfdsguyd', '43245613678'),
(42, 'Lê Ân', 'cloneden001@gmail.com', '', '', ''),
(43, 'Lê Ân', 'cloneden001@gmail.com', '', '', ''),
(44, 'Lê Ân', 'cloneden001@gmail.com', '', '', '');
...
--
ALTER TABLE `chitiethoadon`
  MODIFY `MaHD` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `khachhang`
  MODIFY `MaKH` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
